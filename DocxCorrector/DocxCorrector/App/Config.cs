...
namespace DocxCorrector.App
{
    public static class Config
    {
        ...
        public const string MistakesFilePath = @"C:\Users\Дмитрий\Desktop\paragraph_check\mistakes.json"; 
        //public const string MistakesFilePath = @"C:\Users\haide\Desktop\mistakes.json";
        // Файл для записи свойств параграфов
        public const string PropertiesFilePath = @"C:\Users\Дмитрий\Desktop\paragraph_check\properties.csv";
