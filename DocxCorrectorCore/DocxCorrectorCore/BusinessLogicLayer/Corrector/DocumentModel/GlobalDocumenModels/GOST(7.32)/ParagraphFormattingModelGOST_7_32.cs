...
namespace DocxCorrectorCore.BusinessLogicLayer.Corrector.DocumentModel
{
    public class ParagraphFormattingModelGOST_7_32 : ParagraphFormattingModel
    {
        public override DocumentElement? GetDocumentElementFromClass(ParagraphClass paragraphClass)
        {
            ...
            {
                ParagraphClass.b1 => new HeadingFirstLevelGOST_7_32(),
                ParagraphClass.b2 => new HeadingOtherLevelsGOST_7_32(ParagraphClass.b2),
                ParagraphClass.b3 => new HeadingOtherLevelsGOST_7_32(ParagraphClass.b3),
                ParagraphClass.b4 => new HeadingOtherLevelsGOST_7_32(ParagraphClass.b4),
                ParagraphClass.c1 => new ParagraphRegularGOST_7_32(),
                ParagraphClass.c2 => new ParagraphBeforeListGOST_7_32(),
                ParagraphClass.c3 => new ParagraphBeforeEquationGOST_7_32(),
