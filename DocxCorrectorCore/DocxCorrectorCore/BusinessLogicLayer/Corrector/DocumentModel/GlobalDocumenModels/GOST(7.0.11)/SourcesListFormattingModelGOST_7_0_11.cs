...
{
    public class SourcesListFormattingModelGOST_7_0_11 : SourcesListFormattingModel
    {
        public override List<string> KeyWords => new List<string> { "Список литературы", "Список источников", "Список использованных", "Список использованной" };
        ...
        public override SourcesListCorrections? CheckSourcesList(int id, List<ClassifiedParagraph> classifiedParagraphs)
        {
            ...
            for (int sourcesListElementIndex = id + 1; sourcesListElementIndex < classifiedParagraphs.Count(); sourcesListElementIndex++)
            {
                ...
                var standartSourcesListElement = new SourcesListElementGOST_7_0_11();
